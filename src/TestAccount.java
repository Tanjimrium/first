public class TestAccount {
    public static void main(String[] args) {
        ...
        System.out.print(john.getName() + " (" + john.getGender() + ") at " + john.getEmail() + "\n");
        ...
        a1.setBranch("b1");
        System.out.print("Customer: "+a1.getCustomerName()+" Branch: "+a1.getBranch()+" A/C no: "+a1.getAccountNumber()+" Balance: "+a1.getBalance()+"\n");
        a1.credit(20);
        a1.debit(10);
        System.out.print("Customer: "+a1.getCustomerName()+" Branch: "+a1.getBranch()+" A/C no: "+a1.getAccountNumber()+" Balance: "+a1.getBalance()+"\n");
